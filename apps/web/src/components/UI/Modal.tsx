          ...
          >
            <div
              className={clsx(
                ...
                { 'sm:max-w-lg': size === 'sm' },
                'inline-block align-bottom bg-white bg-gray-800 text-left shadow-xl transform transition-all sm:my-8 sm:align-middle w-full rounded-xl'
              )}
            >
              <div className="flex justify-between items-center py-3.5 px-5 divider">
                ...
                {onClose ? (
                  <button
                    type="button"
                    className="p-1 text-gray-800 rounded-full text-gray-100 hover:bg-gray-200 hover:bg-gray-700"
                    onClick={onClose}
                  >
