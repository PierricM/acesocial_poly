      ...
      {({ open }) => (
        <>
          <Menu.Button
            ...
            aria-label="More"
          >
            <DotsHorizontalIcon className={clsx('text-gray-500 text-gray-300', iconClassName)} />
          </Menu.Button>
          <Transition
            show={open}
            as={Fragment}
          ...
          >
            <Menu.Items
              static
              className="absolute py-1 w-max bg-white rounded-xl border shadow-sm bg-gray-900 focus:outline-none z-[5] border-gray-700/80"
            >
