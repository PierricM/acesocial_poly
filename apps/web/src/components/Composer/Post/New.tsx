    ...
    <Card className="p-5 space-y-3">
      <div className="flex items-center space-x-3">
        <img
          ...
          className="h-9 w-9 bg-gray-200 rounded-full border border-gray-700/80"
          alt={currentProfile?.handle}
        />
        <button
          className="w-full flex items-center space-x-2 bg-gray-100 text-gray-900 bg-gray-900 px-4 py-2 rounded-xl border border-gray-200 border-gray-700"
          type="button"
