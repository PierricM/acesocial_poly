  ...
  return (
    <div className="p-5 space-y-3">
      <div className="flex items-center space-x-2">
        ...
        <div className="text-gray-500 text-gray-400 text-sm font-bold">This post can be collected</div>
      </div>
              ...
              <div className="pt-2">
                <div className="text-sm flex space-x-2">
                  ...
                  <div>
                    ...
                    <select
                      className="w-full bg-white rounded-xl border border-gray-300 outline-none bg-gray-800 disabled:bg-gray-500 disabled:bg-opacity-20 disabled:opacity-60 border-gray-700/80 focus:border-brand-500 focus:ring-brand-400"
